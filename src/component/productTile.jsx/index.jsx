...
const ProductTile = ({ singleProductTile }) => {
    ...
    function handleOnClickToNavigate(getCurrentId){
  ...
  return (
    <div className="relative group border border-cyan-700 p-6 cursor-pointer">
      ...
      <button onClick={()=> handleOnClickToNavigate(singleProductTile?.id)} className="px-5 mt-5 w-full py-2 rounded-none bg-black text-white font-serif text-lg">View Details</button>
    </div>
  );
};
